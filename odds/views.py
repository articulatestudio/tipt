...
def processHorseRequest(parameters):
    ...
    if len(vendors) == 0:
        speech = "I'm struggling with that one. It could be that you made a typo, the race has already started, the horse isn't running today or the betting hasn't opened yet. You can try again or just:\n\n"
